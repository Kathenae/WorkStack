        ...
        >
            ...
            <Container>
                <Card className='mb-4 py-0'>
                    <Card.Content>
                        <div className="flex justify-between">
                            <h2 className="font-semibold text-xl text-gray-800 leading-tight">Jobs Created ({jobs.length})</h2>
                ...
                <Card className='mb-4 mt-0 py-0'>
                    <Card.Content>
                        <div className="flex justify-between">
                            <h2 className="font-semibold text-xl text-gray-800 leading-tight">Sent Proposals ({proposals.length})</h2>
